...
On the Payworks home dashboard, the summary widget shows **Pending Time Off
Requests (All)**. If the count is greater than zero, there are requests waiting
for your approval.
...
accrued balance, timing conflict), check with the GM before approving.
