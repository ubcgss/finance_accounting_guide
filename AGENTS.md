...
<!-- agent_skills:start -->
**Skills and agents in this repo are generated.** Everything under `.codex/skills/` and
`.codex/agents/` is produced by `~/Projects/small_projects/agent_skills/sync.sh`. Never
